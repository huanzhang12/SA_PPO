...
PARAMS = {
    "game": ["Walker2d-v2"],
    "mode": ["robust_ppo"],
    "out_dir": ["robust_ppo_walker/agents"],
    ...
    "save_iters": [10],
    "robust_ppo_eps": [0.05, 0.075],
    "robust_ppo_reg": [0.001, 0.003, 0.01, 0.03, 0.1, 0.3, 1.0],
    "train_steps": [976],
    ...
    "robust_ppo_detach_stdev": [True, False], 
    "robust_ppo_method": ["convex-relax", "sgld"],
}
